        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MainActivity.this, "Права отсутствуют!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_GALLERY_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Аккаунт не выбран", Toast.LENGTH_SHORT)
                        .show();
            }
        ...
        new AsyncTask<Object, Void, BatchAnnotateImagesResponse>() {
            ...
            protected BatchAnnotateImagesResponse doInBackground(Object... params) {
                try {
                    ...
                    Log.d(TAG, "Отправляется запрос в облако Google");

                    BatchAnnotateImagesResponse response = annotateRequest.execute();
                    return response;

                } catch (GoogleJsonResponseException e) {
                    Log.e(TAG, "Ошибка запроса: " + e.getContent());
                } catch (IOException e) {
                    Log.d(TAG, "Ошибка запроса: " + e.getMessage());
                }
                return null;
            }
